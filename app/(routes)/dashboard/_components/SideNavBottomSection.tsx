...
function SideNavBottomSection({onFileCreate,totalFiles}:any) {
  const menuList=[
    ...
    },
    {
      ...
      name:'Github',
      icon:Github,
      path:'https://github.com/AnubhavKishore'
    },
    {
      id:3,
      name:'Archive',
  ...
  <Button className='w-full bg-black text-white
      hover:bg-white hover:text-black justify-start mt-3'>New File</Button>
  </DialogTrigger>
  ...
  <PricingDialog/>}
      ...
      {/* Progress Bar  */}
      <div className='h-4 w-full bg-white rounded-full mt-5'>
