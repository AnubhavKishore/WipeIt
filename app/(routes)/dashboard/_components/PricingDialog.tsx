...
function PricingDialog() {
  return (
    ...
    <DialogHeader>
      <DialogTitle className='text-black justify-center flex font-bold text-3xl'>Upgrade Plan</DialogTitle>
      <DialogDescription>
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    <div
      className="rounded-2xl border border-pink-600 p-6 shadow-sm ring-1 ring-pink-600 sm:order-last sm:px-8 lg:p-12"
    >
      ...
      <Link
        ...
        className="mt-8 block rounded-full border border-pink-600
         bg-pink-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-pink-700 hover:ring-1 hover:ring-pink-700 focus:outline-none focus:ring active:text-pink-500"
      >
        Upgrade
      </Link>
    </div>

    <div className="rounded-2xl border-2 border-green-500  p-6 shadow-sm sm:px-8 lg:p-12">
      <div className="text-center">
