...
<div className="overflow-x-auto rounded-xl">
  <table className="min-w-full divide-y-2 divide-violet-800 bg-pink-100 text-sm">
    <thead className="ltr:text-left rtl:text-right">
      <tr>
      <td className="whitespace-nowrap px-4 py-3 font-bold text-gray-900">File Name</td>
    ...
    <tbody className="divide-y divide-pink-200 rounded-xl">
      {fileList&&fileList.map((file:FILE,index:number)=>(
        <tr key={index} className="odd:bg-pink-50 cursor-pointer"
